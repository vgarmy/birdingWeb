  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl w-full p-12 shadow-lg rounded-lg backdrop-blur-md bg-white/60">
        <h2 className="text-3xl font-bold text-green-900 mb-8 text-center">Kontakta oss</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-green-900 text-white py-3 text-lg rounded-lg hover:bg-green-700 transition duration-300"
          >
            Skicka
          </button>
        </form>

        {/* Placeholder for Success Message to Maintain Height */}
        <div className="h-6 flex justify-center items-center">
          {success && <p className="text-green-900 text-center">Ditt meddelande har skickats!</p>}
        </div>
      </div>
    </section>
